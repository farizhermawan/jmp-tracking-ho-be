...
Route::middleware('jwt')->group(function () {
  ...
  Route::post('/undirect-cost/submit', 'API\UndirectCostController@saveTransaction');
  Route::post('/undirect-cost/remove', 'API\UndirectCostController@remove');
  ...
  Route::post('/undirect-cost', 'API\UndirectCostController@getTransaksi');
  ...
  Route::post('/export/undirect-cost', 'API\UndirectCostController@exportUndirectCost');
});
